...
export default function Home() {
  const localBusinessJsonLd = {
    ...
    url: "https://www.siemensservisizmir.com",
    brand: {
      "@type": "Brand",
      name: "Siemens"
    },
    serviceType: "Siemens Beyaz Eşya Yetkili Servisi",
    description: "siemens beyaz eşya yetkili servisi. Buzdolabı, çamaşır makinesi, bulaşık makinesi, fırın onarımı. Orijinal yedek parça garantisi."
  } as const;
